...
class TransactionAssociatedTitle extends DataClass
  ...
  int get hashCode => Object.hash(associatedTitlePk, categoryFk, title,
      dateCreated, dateTimeModified, order, isExactMatch, archived);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $ScannerTemplatesTable extends ScannerTemplates
  ...
  late final GeneratedColumn<String> defaultTitle = GeneratedColumn<String>(
      'default_title', aliasedName, true,
      additionalChecks: GeneratedColumn.checkTextLength(),
      type: DriftSqlType.string,
      requiredDuringInsert: false,
      defaultValue: const Constant(null));
...
class ScannerTemplate extends DataClass implements Insertable<ScannerTemplate> {
  ...
  ScannerTemplate copyWith(
      ...
      ScannerTemplate(
        ...
        defaultTitle:
            defaultTitle.present ? defaultTitle.value : this.defaultTitle,
      );
...
class Tag extends DataClass implements Insertable<Tag> {
  ...
  Tag copyWithCompanion(TagsCompanion data) {
    return Tag(
      ...
      emojiIconName: data.emojiIconName.present
          ? data.emojiIconName.value
          : this.emojiIconName,
      tagPk: data.tagPk.present ? data.tagPk.value : this.tagPk,
    );
  }
  ...
  @override
  int get hashCode => Object.hash(dateCreated, dateTimeModified, order,
      archived, name, colour, iconName, emojiIconName, tagPk);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Tag &&
...
class $TransactionToTagLinksTable extends TransactionToTagLinks
    with TableInfo<$TransactionToTagLinksTable, TransactionToTagLink> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $TransactionToTagLinksTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _transactionPkMeta =
      const VerificationMeta('transactionPk');
  @override
  late final GeneratedColumn<String> transactionPk = GeneratedColumn<String>(
      'transaction_pk', aliasedName, true,
      type: DriftSqlType.string,
      requiredDuringInsert: false,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
          'REFERENCES transactions (transaction_pk)'));
  ...
  @override
  late final GeneratedColumn<String> tagPk = GeneratedColumn<String>(
      'tag_pk', aliasedName, true,
      type: DriftSqlType.string,
      requiredDuringInsert: false,
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('REFERENCES tags (tag_pk)'));
  @override
  List<GeneratedColumn> get $columns => [transactionPk, tagPk];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'transaction_to_tag_links';
  @override
  VerificationContext validateIntegrity(
      Insertable<TransactionToTagLink> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('transaction_pk')) {
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {transactionPk, tagPk};
  @override
  TransactionToTagLink map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TransactionToTagLink(
      transactionPk: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}transaction_pk']),
      tagPk: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}tag_pk']),
  ...
  @override
  $TransactionToTagLinksTable createAlias(String alias) {
    return $TransactionToTagLinksTable(attachedDatabase, alias);
  }
}

class TransactionToTagLink extends DataClass
    implements Insertable<TransactionToTagLink> {
  final String? transactionPk;
  final String? tagPk;
  const TransactionToTagLink({this.transactionPk, this.tagPk});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    if (!nullToAbsent || transactionPk != null) {
      map['transaction_pk'] = Variable<String>(transactionPk);
    }
    if (!nullToAbsent || tagPk != null) {
      map['tag_pk'] = Variable<String>(tagPk);
    }
    return map;
  }

  TransactionToTagLinksCompanion toCompanion(bool nullToAbsent) {
    return TransactionToTagLinksCompanion(
      transactionPk: transactionPk == null && nullToAbsent
          ? const Value.absent()
          : Value(transactionPk),
      tagPk:
          tagPk == null && nullToAbsent ? const Value.absent() : Value(tagPk),
    );
  }

  factory TransactionToTagLink.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return TransactionToTagLink(
      transactionPk: serializer.fromJson<String?>(json['transactionPk']),
  ...
  TransactionToTagLink copyWith(
          {Value<String?> transactionPk = const Value.absent(),
          Value<String?> tagPk = const Value.absent()}) =>
      TransactionToTagLink(
        transactionPk:
            transactionPk.present ? transactionPk.value : this.transactionPk,
        tagPk: tagPk.present ? tagPk.value : this.tagPk,
      );
  TransactionToTagLink copyWithCompanion(TransactionToTagLinksCompanion data) {
    return TransactionToTagLink(
      transactionPk: data.transactionPk.present
          ? data.transactionPk.value
          : this.transactionPk,
  ...
  @override
  String toString() {
    return (StringBuffer('TransactionToTagLink(')
          ..write('transactionPk: $transactionPk, ')
          ..write('tagPk: $tagPk')
          ..write(')'))
        .toString();
  ...
  @override
  int get hashCode => Object.hash(transactionPk, tagPk);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TransactionToTagLink &&
          other.transactionPk == this.transactionPk &&
          other.tagPk == this.tagPk);
}

class TransactionToTagLinksCompanion
    extends UpdateCompanion<TransactionToTagLink> {
  final Value<String?> transactionPk;
  final Value<String?> tagPk;
  final Value<int> rowid;
  const TransactionToTagLinksCompanion({
    this.transactionPk = const Value.absent(),
    this.tagPk = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  TransactionToTagLinksCompanion.insert({
    this.transactionPk = const Value.absent(),
    this.tagPk = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  static Insertable<TransactionToTagLink> custom({
    Expression<String>? transactionPk,
    Expression<String>? tagPk,
    Expression<int>? rowid,
  }) {
  ...
  TransactionToTagLinksCompanion copyWith(
      {Value<String?>? transactionPk,
      Value<String?>? tagPk,
      Value<int>? rowid}) {
    return TransactionToTagLinksCompanion(
  ...
  @override
  String toString() {
    return (StringBuffer('TransactionToTagLinksCompanion(')
          ..write('transactionPk: $transactionPk, ')
          ..write('tagPk: $tagPk, ')
          ..write('rowid: $rowid')
          ..write(')'))
...
abstract class _$FinanceDatabase extends GeneratedDatabase {
  ...
  late final $TransactionToTagLinksTable transactionToTagLinks =
      $TransactionToTagLinksTable(this);
  @override
...
final class $$TransactionsTableReferences
  ...
  static MultiTypedResultKey<$TransactionToTagLinksTable,
      List<TransactionToTagLink>> _transactionToTagLinksRefsTable(
          _$FinanceDatabase db) =>
      MultiTypedResultKey.fromTable(db.transactionToTagLinks,
          aliasName:
              'transactions__transaction_pk__transaction_to_tag_links__transaction_pk');

  $$TransactionToTagLinksTableProcessedTableManager
      get transactionToTagLinksRefs {
    final manager = $$TransactionToTagLinksTableTableManager(
            $_db, $_db.transactionToTagLinks)
        .filter((f) => f.transactionPk.transactionPk
            .sqlEquals($_itemColumn<String>('transaction_pk')!));

    final cache =
        $_typedResult.readTableOrNull(_transactionToTagLinksRefsTable($_db));
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: cache));
  }
}
...
class $$TransactionsTableFilterComposer
  ...
  Expression<bool> transactionToTagLinksRefs(
      Expression<bool> Function($$TransactionToTagLinksTableFilterComposer f)
          f) {
    final $$TransactionToTagLinksTableFilterComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.transactionPk,
            referencedTable: $db.transactionToTagLinks,
            getReferencedColumn: (t) => t.transactionPk,
            builder: (joinBuilder,
                    {$addJoinBuilderToRootComposer,
                    $removeJoinBuilderFromRootComposer}) =>
                $$TransactionToTagLinksTableFilterComposer(
                  $db: $db,
                  $table: $db.transactionToTagLinks,
                  $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                  joinBuilder: joinBuilder,
                  $removeJoinBuilderFromRootComposer:
                      $removeJoinBuilderFromRootComposer,
...
class $$TransactionsTableAnnotationComposer
  ...
  Expression<T> transactionToTagLinksRefs<T extends Object>(
      Expression<T> Function($$TransactionToTagLinksTableAnnotationComposer a)
          f) {
    final $$TransactionToTagLinksTableAnnotationComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.transactionPk,
            referencedTable: $db.transactionToTagLinks,
            ...
            builder: (joinBuilder,
                    {$addJoinBuilderToRootComposer,
                    $removeJoinBuilderFromRootComposer}) =>
                $$TransactionToTagLinksTableAnnotationComposer(
                  $db: $db,
                  $table: $db.transactionToTagLinks,
                  $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                  joinBuilder: joinBuilder,
...
class $$TransactionsTableTableManager extends RootTableManager<
    ...
    PrefetchHooks Function(
        ...
        bool transactionToTagLinksRefs})> {
  $$TransactionsTableTableManager(
      ...
      : super(TableManagerState(
          ...
          prefetchHooksCallback: (
              ...
              transactionToTagLinksRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
                if (transactionToTagLinksRefs) db.transactionToTagLinks
              ],
              addJoins: <
                  T extends TableManagerState<
                      dynamic,
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (transactionToTagLinksRefs)
                    await $_getPrefetchedData<Transaction, $TransactionsTable,
                            TransactionToTagLink>(
                        currentTable: table,
                        referencedTable: $$TransactionsTableReferences
                            ._transactionToTagLinksRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$TransactionsTableReferences(db, table, p0)
                                .transactionToTagLinksRefs,
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems.where(
                                (e) => e.transactionPk == item.transactionPk),
                        typedResults: items)
                ];
              },
            );
...
class $$ScannerTemplatesTableFilterComposer
  ...
  ColumnFilters<String> get defaultTitle => $composableBuilder(
      column: $table.defaultTitle, builder: (column) => ColumnFilters(column));
...
class $$ScannerTemplatesTableAnnotationComposer
  ...
  GeneratedColumn<String> get defaultTitle => $composableBuilder(
      column: $table.defaultTitle, builder: (column) => column);
...
final class $$TagsTableReferences
    extends BaseReferences<_$FinanceDatabase, $TagsTable, Tag> {
  ...
  static MultiTypedResultKey<$TransactionToTagLinksTable,
      List<TransactionToTagLink>> _transactionToTagLinksRefsTable(
          _$FinanceDatabase db) =>
      MultiTypedResultKey.fromTable(db.transactionToTagLinks,
          aliasName: 'tags__tag_pk__transaction_to_tag_links__tag_pk');
  ...
  $$TransactionToTagLinksTableProcessedTableManager
    ...
    final manager = $$TransactionToTagLinksTableTableManager(
            $_db, $_db.transactionToTagLinks)
        .filter(
            (f) => f.tagPk.tagPk.sqlEquals($_itemColumn<String>('tag_pk')!));
...
class $$TagsTableFilterComposer
    extends Composer<_$FinanceDatabase, $TagsTable> {
  ...
  ColumnFilters<String> get tagPk => $composableBuilder(
      column: $table.tagPk, builder: (column) => ColumnFilters(column));
  ...
  Expression<bool> transactionToTagLinksRefs(
    ...
    final $$TransactionToTagLinksTableFilterComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.tagPk,
            referencedTable: $db.transactionToTagLinks,
            getReferencedColumn: (t) => t.tagPk,
            builder: (joinBuilder,
                    {$addJoinBuilderToRootComposer,
                    $removeJoinBuilderFromRootComposer}) =>
                $$TransactionToTagLinksTableFilterComposer(
...
class $$TagsTableOrderingComposer
  ...
  ColumnOrderings<String> get tagPk => $composableBuilder(
      column: $table.tagPk, builder: (column) => ColumnOrderings(column));
}
...
class $$TagsTableAnnotationComposer
  ...
  GeneratedColumn<String> get tagPk =>
      $composableBuilder(column: $table.tagPk, builder: (column) => column);
...
class $$TagsTableTableManager extends RootTableManager<
    ...
    Tag,
    PrefetchHooks Function({bool transactionToTagLinksRefs})> {
  $$TagsTableTableManager(_$FinanceDatabase db, $TagsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({transactionToTagLinksRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
                if (transactionToTagLinksRefs) db.transactionToTagLinks
                  ...
                  if (transactionToTagLinksRefs)
                    await $_getPrefetchedData<Tag, $TagsTable,
                        ...
                        referencedItemsForCurrentItem: (item,
                                referencedItems) =>
                            referencedItems.where((e) => e.tagPk == item.tagPk),
                        typedResults: items)
                ];
              },
            );
...
typedef $$TagsTableProcessedTableManager = ProcessedTableManager<
    ...
    Tag,
    PrefetchHooks Function({bool transactionToTagLinksRefs})>;
typedef $$TransactionToTagLinksTableCreateCompanionBuilder
    = TransactionToTagLinksCompanion Function({
  Value<String?> transactionPk,
  Value<String?> tagPk,
  Value<int> rowid,
});
typedef $$TransactionToTagLinksTableUpdateCompanionBuilder
    = TransactionToTagLinksCompanion Function({
  Value<String?> transactionPk,
  Value<String?> tagPk,
  Value<int> rowid,
...
final class $$TransactionToTagLinksTableReferences extends BaseReferences<
    _$FinanceDatabase, $TransactionToTagLinksTable, TransactionToTagLink> {
  $$TransactionToTagLinksTableReferences(
      super.$_db, super.$_table, super.$_typedResult);

  static $TransactionsTable _transactionPkTable(_$FinanceDatabase db) =>
      db.transactions.createAlias(
          'transaction_to_tag_links__transaction_pk__transactions__transaction_pk');

  $$TransactionsTableProcessedTableManager? get transactionPk {
    final $_column = $_itemColumn<String>('transaction_pk');
    if ($_column == null) return null;
    final manager = $$TransactionsTableTableManager($_db, $_db.transactions)
        .filter((f) => f.transactionPk.sqlEquals($_column));
    final item = $_typedResult.readTableOrNull(_transactionPkTable($_db));
    if (item == null) return manager;
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: [item]));
  }

  static $TagsTable _tagPkTable(_$FinanceDatabase db) =>
      db.tags.createAlias('transaction_to_tag_links__tag_pk__tags__tag_pk');

  $$TagsTableProcessedTableManager? get tagPk {
    final $_column = $_itemColumn<String>('tag_pk');
    if ($_column == null) return null;
    final manager = $$TagsTableTableManager($_db, $_db.tags)
        .filter((f) => f.tagPk.sqlEquals($_column));
    final item = $_typedResult.readTableOrNull(_tagPkTable($_db));
    if (item == null) return manager;
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: [item]));
  }
...
class $$TransactionToTagLinksTableFilterComposer
    extends Composer<_$FinanceDatabase, $TransactionToTagLinksTable> {
  $$TransactionToTagLinksTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
  ...
  $$TransactionsTableFilterComposer get transactionPk {
    final $$TransactionsTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.transactionPk,
        referencedTable: $db.transactions,
  ...
  $$TagsTableFilterComposer get tagPk {
...
class $$TransactionToTagLinksTableOrderingComposer
    extends Composer<_$FinanceDatabase, $TransactionToTagLinksTable> {
  $$TransactionToTagLinksTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  $$TransactionsTableOrderingComposer get transactionPk {
    final $$TransactionsTableOrderingComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.transactionPk,
        referencedTable: $db.transactions,
  ...
  $$TagsTableOrderingComposer get tagPk {
...
class $$TransactionToTagLinksTableAnnotationComposer
    extends Composer<_$FinanceDatabase, $TransactionToTagLinksTable> {
  $$TransactionToTagLinksTableAnnotationComposer({
    required super.$db,
    required super.$table,
  ...
  $$TransactionsTableAnnotationComposer get transactionPk {
    final $$TransactionsTableAnnotationComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.transactionPk,
        referencedTable: $db.transactions,
  ...
  $$TagsTableAnnotationComposer get tagPk {
...
class $$TransactionToTagLinksTableTableManager extends RootTableManager<
    _$FinanceDatabase,
    $TransactionToTagLinksTable,
    TransactionToTagLink,
    $$TransactionToTagLinksTableFilterComposer,
    $$TransactionToTagLinksTableOrderingComposer,
    $$TransactionToTagLinksTableAnnotationComposer,
    $$TransactionToTagLinksTableCreateCompanionBuilder,
    $$TransactionToTagLinksTableUpdateCompanionBuilder,
    (TransactionToTagLink, $$TransactionToTagLinksTableReferences),
    TransactionToTagLink,
    PrefetchHooks Function({bool transactionPk, bool tagPk})> {
  $$TransactionToTagLinksTableTableManager(
      _$FinanceDatabase db, $TransactionToTagLinksTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          updateCompanionCallback: ({
            ...
            Value<int> rowid = const Value.absent(),
              ...
              TransactionToTagLinksCompanion(
            transactionPk: transactionPk,
            tagPk: tagPk,
            rowid: rowid,
          ),
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$TransactionToTagLinksTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: ({transactionPk = false, tagPk = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins: <
                ...
                if (transactionPk) {
                  state = state.withJoin(
                    currentTable: table,
                    currentColumn: table.transactionPk,
                    referencedTable: $$TransactionToTagLinksTableReferences
                        ._transactionPkTable(db),
                    referencedColumn: $$TransactionToTagLinksTableReferences
                        ._transactionPkTable(db)
                        .transactionPk,
                  ) as T;
                }
                if (tagPk) {
                  state = state.withJoin(
                    currentTable: table,
                    currentColumn: table.tagPk,
                    referencedTable:
                        $$TransactionToTagLinksTableReferences._tagPkTable(db),
                    referencedColumn: $$TransactionToTagLinksTableReferences
                        ._tagPkTable(db)
                        .tagPk,
                  ) as T;
...
typedef $$TransactionToTagLinksTableProcessedTableManager
    = ProcessedTableManager<
        _$FinanceDatabase,
        $TransactionToTagLinksTable,
        TransactionToTagLink,
...
class $FinanceDatabaseManager {
  ...
  $$TransactionToTagLinksTableTableManager get transactionToTagLinks =>
      $$TransactionToTagLinksTableTableManager(_db, _db.transactionToTagLinks);
}
